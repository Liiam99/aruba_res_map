  ...
  fetch("/locations")
    ...
    .then((locations) => {
      locations.forEach((location) => {
        ...
        let popup = new mapboxgl.Popup({ offset: 25 }).setHTML(popup_content);
        ...
        popup._closeButton.addEventListener("click", () => {
          ...
          let overview_nav_button =
            popup._content.querySelector("#nav-overview-tab");
...
function colour_locations(locations) {
  ...
  if (points == 100) {
    locations.forEach((location) => {
      ...
      location_icon.style.backgroundImage =
        "url('static/map/images/orange_icon.png')";
    });
  } else {
    locations.forEach((location, index) => {
      ...
      if (index == 0 || index == 1) {
        location_icon.style.backgroundImage =
          "url('static/map/images/green_icon.png')";
      } else if (index > 1 && index < 5) {
        location_icon.style.backgroundImage =
          "url('static/map/images/yellow_icon.png')";
      } else if (index == 5 || index == 6) {
        location_icon.style.backgroundImage =
          "url('static/map/images/red_icon.png')";
      }
    });
  }
}
